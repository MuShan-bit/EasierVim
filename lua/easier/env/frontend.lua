...
return function(config)
  return {
    ...
    getLSPConfigMap = function()
      local list = {
        tsserver = require("easier.lsp.config.typescript"),
        cssls = require("easier.lsp.config.css"),
        emmet_ls = require("easier.lsp.config.emmet"),
        html = require("easier.lsp.config.html"),
      }
      if config.tailwindcss then
        list.tailwindcss = require("easier.lsp.config.tailwindcss")
      end
      if config.vue then
        list.volar = require("easier.lsp.config.volar")
      end
      if config.prisma then
        list.prismals = require("easier.lsp.config.prismals")
      end
