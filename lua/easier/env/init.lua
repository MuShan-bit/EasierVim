...
local init = function(userConfig)
  table.insert(enabledEnv, require("easier.env.common")(userConfig))
  if userConfig.lua.enable then
    table.insert(enabledEnv, require("easier.env.lua")(userConfig.lua))
  end
  if userConfig.frontend.enable then
    table.insert(enabledEnv, require("easier.env.frontend")(userConfig.frontend))
  end
  if userConfig.golang.enable then
    table.insert(enabledEnv, require("easier.env.golang")(userConfig.golang))
  end
  if userConfig.clangd.enable then
    table.insert(enabledEnv, require("easier.env.clangd")(userConfig.clangd))
  end
  if userConfig.rust.enable then
    table.insert(enabledEnv, require("easier.env.rust")(userConfig.rust))
  end
  if userConfig.bash.enable then
    table.insert(enabledEnv, require("easier.env.bash")(userConfig.bash))
  end
  if userConfig.python.enable then
    table.insert(enabledEnv, require("easier.env.python")(userConfig.python))
  end
  if userConfig.ruby.enable then
    table.insert(enabledEnv, require("easier.env.ruby")(userConfig.ruby))
  end
  if userConfig.json.enable then
    table.insert(enabledEnv, require("easier.env.json")(userConfig.json))
  end
  if userConfig.yaml.enable then
    table.insert(enabledEnv, require("easier.env.yaml")(userConfig.yaml))
  end
  if userConfig.markdown.enable then
    table.insert(enabledEnv, require("easier.env.markdown")(userConfig.markdown))
  end
  if userConfig.docker.enable then
    table.insert(enabledEnv, require("easier.env.docker")(userConfig.docker))
  end
  if userConfig.solidity.enable then
    table.insert(enabledEnv, require("easier.env.solidity")(userConfig.solidity))
  end
  if userConfig.java.enable then
    table.insert(enabledEnv, require("easier.env.java")(userConfig.java))
  end
end
