...
local UserConfig = {
  ...
  keys = {
    leader_key = " ",
    -- quick save / quite （n mode effective）
    save = {"w", "W"},
    quit = "q",
    force_quit = "Q",

    -- move （n/v/x mode effective）
    move = {
      -- make a move
      up = {"i", "<up>"},
      down = {"k", "<down>"},
      ...
      quick_left = "J",
      quick_right = "L",
      -- Step length: The distance quickly moved
      row_step = "3", -- ↑↓
      col_step = "5", -- ←→
    },
    -- insert direction
    insert = {
      left = "a",
      right = "d",
      row_left = "A", -- most left
      row_right = "D", -- most right
    },
    
    -- cancel and repeat(The keyword cannot be used)
    cancel = "u",
    repetition = "r",

    -- cut
    cut = {
      base = "e", -- Cut the selected part in v mode
      -- (n mode effective)
      up = "ei",
      down = "ek",
      left = "ej",
    ...
    -- copy
    copy = {
      base = "c", -- Copy the selected part in v mode
      -- (n mode effective)
      up = "ci",
      down = "ck",
      left = "cj",
    ...
    -- paste (n mode effective)
    paste = { 
      left = "P",
      right = "p",
    },
    -- Indent code (n/v mode effective)
    idenindent = {
      left = "<",
      right = ">",
    },
    ...
    terminal = {
      open = "tt",
      vertical_open = {"ti", "tk"},
      horizontal_open = {"tj", "tl"},
      back_normal = "<Esc>",
    },

    -- transfer (x/v mode effective)
    transfer = {
      up = "<C-i>",
      down = "<C-k>",
    },
