...
if dap and dapui and vt then
  ...
  require("easier.dap.nvim-dap.ui")
  ...
  if cfg.lua and cfg.lua.enable then
    require("easier.dap.nvim-dap.config.lua").setup()
  end
  ...
  --   require("easier.dap.nvim-dap.config.cpp").setup()
  -- end

  if cfg.frontend and cfg.frontend.enable then
    require("easier.dap.nvim-dap.config.vscode-js")
  end

  require("easier.dap.nvim-dap.common-config").keyAttach()
end
