...
mason_config.setup({
  ensure_installed = require("easier.env").getLSPEnsureList(),
})

mason_tool.setup({
  ensure_installed = require("easier.env").getToolEnsureList(),
})

local servers = require("easier.env").getLSPConfigMap()
